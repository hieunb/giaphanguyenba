...
- [Roadmap & Tính năng tương lai](#roadmap--tính-năng-tương-lai)
...
## Cách 3: Deploy với Docker (Khuyến nghị cho Production)

**Yêu cầu:** Docker và Docker Compose đã cài đặt

Docker giúp đảm bảo ứng dụng chạy nhất quán trên mọi môi trường. Phù hợp cho:
- Production deployment trên VPS/Cloud
- Staging environment để đánh giá tính năng
- Testing với môi trường giống production
...
cp .env.example .env
nano .env  # Điền thông tin Supabase
...
Xem [docs/DOCKER.md](docs/DOCKER.md) cho:
...
Gia Phả OS đang được phát triển để trở thành **"nền tảng quản trị cộng đồng dòng họ"** với các module nâng cao:

### 🏆 1. Vinh danh thành tích
- Bảng vàng thành tích của con cháu trong dòng họ
- Ghi nhận học tập, sự nghiệp, đóng góp xã hội
- Truyền cảm hứng cho thế hệ trẻ

### 💰 2. Quỹ Họ & Quỹ Khuyến học
- Quản lý tài chính minh bạch
- Theo dõi đóng góp và chi tiêu
- Báo cáo tài chính công khai
- Hỗ trợ học sinh giỏi, người khó khăn

### 📅 3. Lịch sự kiện dòng họ
- Quản lý giỗ tổ, họp họ, lễ khánh thành
- Hỗ trợ âm lịch / dương lịch
- RSVP xác nhận tham dự
- Album ảnh sự kiện

### 📚 4. Kho tài liệu dòng họ
- Thư viện số: gia phả, sắc phong, văn bia
- Lưu trữ ảnh, video lịch sử
- Tìm kiếm và phân loại thông minh
- Bảo tồn di sản văn hóa

### 🤖 5. Tính năng AI (Tương lai)
- OCR đọc gia phả giấy
- AI tìm quan hệ huyết thống
- Chatbot về lịch sử dòng họ
- Tự động viết lịch sử gia phả

**📖 Xem chi tiết:** [ROADMAP.md](docs/ROADMAP.md)
...
- **Demo công khai:** Trang demo tại `https://giaphanguyenba.vercel.app/` sử dụng dữ liệu mẫu hư cấu, không chứa thông tin của người thật. Không nên nhập thông tin cá nhân thật vào trang demo.
